...
image:https://codecov.io/gh/cybersouris/tomovee/branch/main/graph/badge.svg[codecov,link=https://codecov.io/gh/cybersouris/tomovee] image:https://github.com/cybersouris/tomovee/actions/workflows/lint.yaml/badge.svg[lint,link=https://github.com/cybersouris/tomovee/actions/workflows/lint.yaml] image:https://img.shields.io/badge/golangci--lint-clean-brightgreen?logo=golang&logoColor=white[golangci-lint,link=https://github.com/cybersouris/tomovee/actions/workflows/lint.yaml] image:https://github.com/cybersouris/tomovee/actions/workflows/release.yaml/badge.svg[release,link=https://github.com/cybersouris/tomovee/actions/workflows/release.yaml] image:https://img.shields.io/github/go-mod/go-version/cybersouris/tomovee[go version,link=https://go.dev/] image:https://img.shields.io/github/v/release/cybersouris/tomovee[release version,link=https://github.com/cybersouris/tomovee/releases]

image::internal/webui/src/assets/logo-full.png[Tomovee logo,width=200,float=left]
...
|`POST` |`/api/v1/catalog/{id}/reclassify` |Force the media type (`{"media_type": "series"}` or `{"media_type": "movie"}`)
|`POST` |`/api/v1/versions/{version_id}/split` |Cut one file out and match it as a movie of its own
|`POST` |`/api/v1/versions/{version_id}/episode` |Attach one file to an episode (`{"season": 1, "episode": 9}`)
